...
(defun qiang-set-font (english-fonts
  ...
  (save-excursion
    (with-current-buffer (find-file-noselect "~/.emacs.d/emacs-font-size")
...
(defvar bhj-chinese-fonts '("Microsoft Yahei" "Microsoft_Yahei" "Î¢ÈíÑÅºÚ" "ÎÄÈªæäµÈ¿íÎ¢Ã×ºÚ" "ºÚÌå" "ÐÂËÎÌå" "ËÎÌå"))
...
; ÄãÄãÄãÄãÄãÄãÄãÄãÄãÄãÄãÄãÄãÄãÄãÄãÄãÄãÄãÄã
